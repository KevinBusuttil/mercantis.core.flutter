        ...
        children: [
          ...
          Expanded(
            child: rows.isEmpty
                ...
                : ListView.separated(
                    padding: const EdgeInsets.symmetric(vertical: MercantisSpacing.xs),
                    itemCount: rows.length,
                    separatorBuilder: (_, __) => const Divider(height: 1, indent: 16, endIndent: 16),
                    itemBuilder: (context, i) {
                      final row = rows[i];
                      final selected = row.id == selectedId;
                      return _Row(row: row, selected: selected, onTap: onRowTap);
                    },
                  ),
          ),
          if (onNew != null)
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (row.timestamp != null)
                            Text(row.timestamp!, style: theme.textTheme.bodySmall),
                        ],
                      ),
                    ],
                  ],
